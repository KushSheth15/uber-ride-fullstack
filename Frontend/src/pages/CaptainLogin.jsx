    ...
    <div className='p-7 h-screen flex flex-col justify-between'>
      <div>
        ...
        <form onSubmit={(e)=>{
          ...
          <p className='text-center'>Join a fleet? <Link to='/captain-signup' className='text-blue-600'>Register as new captain</Link></p>
      </div>
      <div>
